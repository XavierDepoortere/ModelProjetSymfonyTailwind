 ...
 */
final class Version20230810094824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD campus_id INT NOT NULL, ADD pseudo VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP campus_id, DROP pseudo');
    }
}
